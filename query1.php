...
<body>
    ...
    <div class="content-text">
        <h3>Query 1</h3>
        <p>Menampilkan nama belakang semua pelanggan yang sekarang menyewa mobil dari perusahaan.</p>
    </div>
    <div>
        <table>
            <tr>
            ...
            <?php
            $Datas = mysqli_query($koneksi, "SELECT customer.driver_lic, last_name
            FROM customer, person, rental
            WHERE customer.driver_lic = rental.driver_lic AND customer.driver_lic =
            person.driver_lic AND rental.to_date IS NULL");

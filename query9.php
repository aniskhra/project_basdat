...
<body>
    ...
    <div class="content-text">
        <h3>Query 9</h3>
        <p>Menampilkan nilai sewa termurah dengan menggunakan Query 3 sebagai inner query.</p>
    </div>
    <div>
        <table>
            <tr>
                <th>Nilai Sewa Termurah</th>
            </tr>
            <tbody>

            <?php
            // Include the stored procedure call
            $sql = "CALL CalculateMinCharge()";
